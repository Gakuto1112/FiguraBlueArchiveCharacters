    ...
    new = function (objectModel, objectIndex, objectData, pos, rot)
        ...
        instance.onTick = function ()
            ...
            elseif not instance.hasFireResistance and (nextBlock:getFluidTags()[2] == "c:lava" or isNextBlockFire) then
                sounds:playSound(NameUtils:checkSound("minecraft:block.fire.extinguish"), instance.nextPos)
                for _ = 0, instance.boundingBox.x * instance.boundingBox.y * instance.boundingBox.z * 8 do
                    particles:newParticle(NameUtils:checkParticle("minecraft:smoke"), vectors.vec3(instance.nextPos.x + math.random() * instance.boundingBox.x - instance.boundingBox.x / 2, instance.nextPos.y + math.random() * instance.boundingBox.y, instance.nextPos.z + math.random() * instance.boundingBox.z - instance.boundingBox.z / 2))
                end
