...
events.RENDER:register(function()
    if not renderProcessed then
        ...
        --頭の輪っかの角度を設定
        models.models.main.Avatar.Head.HeadRing:setRot(HeadRing.HeadRotAverage - headRot + BlueArchiveCharacter.HEAD_RING_NEUTRAL_ROT)
...
events.SKULL_RENDER:register(function()
    models.models["skull_"..BlueArchiveCharacter.COSTUME[Costume.CurrentCostume].name].Skull.HeadRing:setPos(0, math.sin(HeadRing.FloatCount * 2 * math.pi) * 0.25)
end)
