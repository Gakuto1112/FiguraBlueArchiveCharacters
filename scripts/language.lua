...
Language = {
	LanguageData = {
		en_us = {
			...
			action_wheel__option_unavailable = "This action is currently unavailable.",
			...
			action_wheel__main__action_3__title = "§7Change display name: ",
			action_wheel__main__action_3__title_2 = "§7Show club name: ",
		...
		ja_jp = {
			...
			action_wheel__option_unavailable = "このアクションは現在利用できません。",
			...
			action_wheel__main__action_3__title = "§7表示名を変更：",
			action_wheel__main__action_3__title_2 = "§7部活名を表示：",
