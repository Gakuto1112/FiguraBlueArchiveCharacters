...
Language = {
	LanguageData = {
		en_us = {
			...
			action_wheel__main__action_5__title = "Accuracy of camera during ex skill animations: ",
			action_wheel__main__action_5__option_1 = "Standard",
			action_wheel__main__action_5__option_2 = "High",
			action_wheel__main__action_5__option_3 = "Very high",
			action_wheel__main__action_5__option_4 = "Ultra high",
			action_wheel__main__action_5__done_first = "Changed camera accuracy during ex skill animations to §b",
			action_wheel__main__action_5__done_last = "§r.",
			action_wheel__main__action_6__title = "Amount of particles in Ex skill frame: ",
			action_wheel__main__action_6__option_1 = "Standard",
			action_wheel__main__action_6__option_2 = "Minimum",
			action_wheel__main__action_6__option_3 = "None",
			action_wheel__main__action_6__done_first = "Changed amount of particles in Ex skill frame to§b",
			action_wheel__main__action_6__done_last = "§r.",
		...
		ja_jp = {
			...
			action_wheel__main__action_5__title = "Exスキルアニメーション中のカメラ精度：",
			action_wheel__main__action_5__option_1 = "標準",
			action_wheel__main__action_5__option_2 = "やや高い",
			action_wheel__main__action_5__option_3 = "高い",
			action_wheel__main__action_5__option_4 = "非常に高い",
			action_wheel__main__action_5__done_first = "Exスキルアニメーション中のカメラの精度を§b",
			action_wheel__main__action_5__done_last = "§rに変更しました。",
			action_wheel__main__action_6__title = "Exスキルフレームのパーティクルの量：",
			action_wheel__main__action_6__option_1 = "標準",
			action_wheel__main__action_6__option_2 = "少なめ",
			action_wheel__main__action_6__option_3 = "なし",
			action_wheel__main__action_6__done_first = "Exスキルフレームのパーティクルの量を§b",
			action_wheel__main__action_6__done_last = "§rに変更しました。",
